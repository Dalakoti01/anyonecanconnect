...
const DashboardClient = () => {
  ...
  return (
    <div className="relative pt-5">
      <div className="pb-5 flex flex-col bg-[#fcfcfc] min-h-screen px-2 sm:px-4 md:px-6">
        {/* Main Content - Full Width on Mobile/Tablet, Split on Desktop */}
        <div className="w-full">
          {/* Welcome and Performance */}
          <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-10 items-center px-0 sm:px-2 md:px-4 py-4">
            ...
            <div className="flex flex-col w-full md:w-1/2 p-5 sm:p-10 py-8 justify-center items-center gap-5 rounded-lg bg-[rgb(241,236,236)]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                <div className="shadow-xl flex flex-col gap-2 justify-center items-center flex-1 bg-white p-4 rounded-lg border-t-4 border-blue-800">
                  <h1 className="font-bold text-xl sm:text-2xl">
                    {activeJobsCount}
                  </h1>
                  <p>Active Jobs</p>
                </div>
                <div className="shadow-xl flex flex-col gap-2 justify-center items-center flex-1 bg-white p-4 rounded-lg border-t-4 border-green-800">
                  <h1 className="font-bold text-xl sm:text-2xl">
                    {user?.connectedFreelancers?.length}
                  </h1>
                  <p>Talent Connections</p>
                </div>
                <div className="shadow-xl flex flex-col gap-2 justify-center items-center flex-1 bg-white p-4 rounded-lg border-t-4 border-yellow-500">
          ...
          {/* Two Column Layout for larger screens, Single column for mobile/tablet */}
          <div className="flex flex-col xl:flex-row gap-6 px-0 sm:px-2 md:px-4">
            {/* Left Column - Active Jobs */}
            <div className="w-full xl:w-2/3">
              <div className="flex flex-col overflow-hidden">
                <div className="bg-white mt-7 w-full rounded-md shadow-xl pt-6 sm:pt-10">
                  ...
                  <div className="overflow-x-auto">
                    {filteredJobs?.map((job) => (
                      <div
                        key={job?._id}
                        className="pt-4 sm:pt-5 px-3 sm:px-5 cursor-pointer flex flex-col gap-2 bg-white w-full rounded-md hover:bg-slate-200"
                      >
            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-6">
              {/* Filter Dropdown */}
              <div className="bg-white w-full max-w-[300px] text-black mx-auto xl:mx-0">
              ...
              {/* Profile Card */}
              <div className="bg-white w-full flex flex-col justify-center rounded-md items-center gap-5 p-4 sm:p-5">
                <Avatar>
                ...
                <div className="flex flex-wrap justify-center gap-3 w-full">
                  <div className="bg-slate-100 rounded-md flex p-3 sm:p-4 flex-col gap-2 sm:gap-4 flex-1 min-w-[140px]">
                    <h1 className="text-xs sm:text-base text-center">
                      Feedback By Freelancer
                    </h1>
              ...
              {/* Hiring Assistant */}
              <div className="p-4 sm:p-5 rounded-sm bg-blue-700 text-white font-bold flex flex-col gap-4 sm:gap-5 w-full">
                ...
                <Button
                  variant="outline"
                  className="bg-white text-blue-500 w-full sm:w-auto"
                >
                  Try Assistant
                </Button>
              </div>
              ...
              <div className="w-full">
                <div className="bg-white flex justify-between items-center border-b-2 rounded-md border-slate-300 p-4">
                ...
                <div className="flex flex-col gap-0">
                  {displayFreelancers?.map((freelancers) => (
                    <div
                      className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white w-full p-4 gap-3 border-b border-slate-100 last:border-b-0"
                      key={freelancers?._id}
                    >
                        ...
                        <div className="flex flex-col gap-1 w-full min-w-0">
                          ...
                          <p className="text-xs sm:text-sm line-clamp-2 text-gray-600">
                            {freelancers?.profile?.bio
                              ...
                              .slice(0, 20)
                              .join(" ") +
                              (freelancers?.profile?.bio?.split(" ").length > 20
                                ? "..."
                                : "")}
                          </p>
                          <h1 className="text-xs sm:text-base text-yellow-600">
                            Rating: 4.0
                          </h1>
                        </div>
                      </div>
                      <Button
                        ...
                        className="text-blue-500 bg-transparent border border-blue-500 hover:bg-blue-50 px-4 py-2 text-sm whitespace-nowrap self-end sm:self-center"
                        variant="outline"
                      >
                        Connect
                      </Button>
