...
const SubmitPopover = ({ open, setOpen, jobId }) => {
  ...
  const submitHandler = async () => {
    try {
      ...
      const res = await axios.post(
        `/api/application/applyJobs/${selectedJob?._id}`,
        body,
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      {/* ✅ Centered Dialog */}
      <DialogContent className="w-[95vw] max-w-[1200px] max-h-[90vh] overflow-y-auto bg-white shadow-lg p-6 rounded-lg">
